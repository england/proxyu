...
;(function(){
  ...
  if($ === undefined || $.fn.foundation === undefined){
    throw 'foundation not loaded!';
  }

  console.log('Modernizr, jQuery and Foundation are loaded.');
...
;(function(){
  /**
   * Set up event handlers and other aspects of navigation on flat pages
   */
  var setUpNavigation = function()
  {
    ...
    selectors = {
      ...
      sideNav: [
        ".reveal-container-side",
        ".reveal-container-side-click-catcher"
      ]
    };

    hideSideNav = function()
    {
      $(selectors.sideNav.join(", ")).removeClass("active");
    };

    hideTopNav = function()
    {
      $(selectors.topNav.join(", ")).removeClass("active");
    };

    /*
    event handlers: large screen nav
     */
    ($(".europa-dip").on("click", ".reveal-button a", function(e) {
      e.preventDefault();
      hideSideNav();
      $(".reveal-container-top").toggleClass("active");
    }));

    ($(".europa-dip").on("click", ".reveal-container-top .close-button", function(e) {
      e.preventDefault();
      hideTopNav();
    }));

    /*
    event handlers: small screen nav
     */
    ($(".europa-dip").on("click", ".hamburger-button a", function(e) {
      e.preventDefault();
      hideTopNav();
      $(".reveal-container-side-click-catcher").toggleClass("active");
      $(".reveal-container-side").toggleClass("active");
    }));

    ($(".europa-dip").on("click", ".reveal-container-side-click-catcher", function(e) {
      e.preventDefault();
      hideSideNav();
    }));

    // remove the loading class on side nav so that future transitions are animated
    $(".europa-dip .reveal-container-side").removeClass("init");
  };
